...
/*    Default                      Keyboard             Mouse                PS3                  PS4 / PS5            Wiimote              Wiimote + Classic    Wiimote + Nunchuck   WiiU / Switch Pro    Switch Joycon        Xbox One S / X|S     Steam                NeoGeo (Paraller 1P) PCE                  NES                  SNES                 CD-i                 JVS                  3DO                  Jaguar               PC-FX                N64                         GameCube             Atari / SMS          MD / Genesis         Saturn               Dreamcast            PSX / PS2           */
    ...
    ['GP: RB Left;  KB: Q; M: 4', 'KB: Q',             'M: 4',              'Square',            'Square',            'B',                 '[C] Y',             '[W] A',             'Y',                 'B | D-pad up',      'X',                 'X',                 'C',                 '*IV',               'B',                 'Y',                 '',                  '3',                 'A',                 'Z (1)',             'IV',                'B',                        'B',                 '1',                 '*X',                'X',                 'X',                 'Square',           ],
    ...
    ['GP: MS; KB: Enter',         'KB: Enter',         '',                  'Select',            'SHARE',             '-',                 '[C] -',             '',                  '-',                 '- | Home',          'View',              'Back',              'Select',            'Select',            'Select',            'Select',            '',                  'Coin',              'X',                 'Pause',             'Select',            '',                         '',                  '',                  '*Mode',             '',                  '*D',                'Select',           ],
    ['GP: MT; KB: L Win',         'KB: L Win',         '',                  'PS',                'PS',                'Home',              '[C] Home',          '',                  'Home',              '',                  'Xbox',              'Steam',             'Credit',            '',                  '',                  '',                  '',                  'Service',           'PS',                '5',                 '',                  '**Toggle Ctrl/Rumble pak', '',                  '',                  '',                  '',                  '',                  'Analog',           ],
    ['GP: MQ; KB: Hash',          'KB: Hash',          '',                  '',                  'TouchPad',          '',                  '[W] B',             '',                  'Capture',           '',                  'Share',             'Stick click',       '',                  '',                  '',                  '',                  '',                  '',                  '',                  '8',                 '',                  '**Rotate memory bank',     '',                  '',                  '',                  '',                  '',                  '',                 ],
    ['GP: LM; M: Right',          '',                  'M: Right',          'L2',                'L2',                '',                  '[C] Analog L',      '[N] Z',             'ZL',                'SL',                'LT',                'Analog LT',         '6',                 '*VI',               '',                  'L',                 '',                  '5',                 'L',                 '*Z Axis',           'VI',                'Z',                        'Analog L',          '',                  '',                  '*Analog L',         'L',                 'L2',               ],
    ['GP: LS; KB: Z',             'KB: Z',             '',                  'L1',                'L1',                '',                  '[C] ZL',            '[N] C',             'L',                 'L | R',             'LB',                'LB',                '',                  '',                  '',                  '',                  '',                  '7',                 '',                  'X (3)',             'Mode 1',            'L',                        'Z',                 '',                  '*Z',                'Z',                 '*Z',                'L1',               ],
