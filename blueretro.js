...
var btnList = [
/*    Default                      Keyboard             Mouse                PS3                  PS4 / PS5            Wiimote              Wiimote + Classic    Wiimote + Nunchuck   WiiU / Switch Pro    Switch Joycon        Xbox One S / X|S     Steam                NeoGeo (Paraller 1P) PCE                  NES                  SNES                 CD-i                 JVS                  3DO                  Jaguar               PC-FX                VB                          N64                         GameCube             Atari / SMS          MD / Genesis         Saturn               Dreamcast            PSX / PS2           */
    ...
    ['GP: RX Left;  M: X Left',   '',                  'M: X Left',         'Right stick left',  'Right stick left',  '',                '[C] Right stick left', '',                 'Right stick left',  '',                  'Right stick left',  'Right pad left',    '',                  '',                  '',                  '',                  '',                  '',                  '',              '*Right stick left (TX)', '',                 'Right D-pad left',         'C-Left',                   'Right stick left',  '',                  '',                  '',                  '*Right stick left', 'Right stick left', ],
    ['GP: RX Right; M: X Right',  '',                  'M: X Right',        'Right stick right', 'Right stick right', '',                '[C] Right stick right','',                 'Right stick right', '',                  'Right stick right', 'Right pad right',   '',                  '',                  '',                  '',                  '',                  '',                  '',              '*Right stick right (TX)','',                 'Right D-pad right',        'C-Right',                  'Right stick right', '',                  '',                  '',                  '*Right stick right','Right stick right',],
    ['GP: RY Down;  M: Y Down',   '',                  'M: Y Down',         'Right stick down',  'Right stick down',  '',                '[C] Right stick down', '',                 'Right stick down',  '',                  'Right stick down',  'Right pad down',    '',                  '',                  '',                  '',                  '',                  '',                  '*Throttle down','*Right stick down (TY)', '',                 'Right D-pad down',         'C-Down',                   'Right stick down',  '',                  '',                  '',                  '*Right stick down', 'Right stick down', ],
    ['GP: RY Up;    M: Y Up',     '',                  'M: Y Up',           'Right stick up',    'Right stick up',    '',                '[C] Right stick up',   '',                 'Right stick up',    '',                  'Right stick up',    'Right pad up',      '',                  '',                  '',                  '',                  '',                  '',                  '*Throttle up',  '*Right stick up (TY)',   '',                 'Right D-pad up',           'C-Up',                     'Right stick up',    '',                  '',                  '',                  '*Right stick up',   'Right stick up',   ],
    ...
    ['GP: LD Down;  KB: Down',    'KB: Down',          '',                  'D-pad down',        'D-pad down',        'D-pad down (H)',  '[C] D-pad down',     '[W] D-pad down (V)', 'D-pad down',        '',                  'D-pad down',        'Stick down',        'D-pad down',        'D-pad down',        'D-pad down',        'D-pad down',        '',                  'D-pad down',        'D-pad down',        'D-pad down',        'D-pad down',        'Left D-pad down',          'D-pad down',               'D-pad down',        'D-pad down',        'D-pad down',        'D-pad down',        'Left D-pad down',   'D-pad down',       ],
    ['GP: LD Up;    KB: Up',      'KB: Up',            '',                  'D-pad up',          'D-pad up',          'D-pad up (H)',    '[C] D-pad up',       '[W] D-pad up (V)',   'D-pad up',          '',                  'D-pad up',          'Stick up',          'D-pad up',          'D-pad up',          'D-pad up',          'D-pad up',          '',                  'D-pad up',          'D-pad up',          'D-pad up',          'D-pad up',          'Left D-pad up',            'D-pad up',                 'D-pad up',          'D-pad up',          'D-pad up',          'D-pad up',          'Left D-pad up',     'D-pad up',         ],
    ...
    ['GP: RB Left;  KB: Q; M: 4', 'KB: Q',             'M: 4',              'Square',            'Square',            'B',                 '[C] Y',             '[W] A',             'Y',                 'B | D-pad up',      'X',                 'X',                 'C',                 '*IV',               'B',                 'Y',                 '',                  '3',                 'A',                 'Z (1)',             'IV',                'B',                        'B',                        'B',                 '1',                 '*X',                'X',                 'X',                 'Square',           ],
    ['GP: RB Right; KB: R; M: 5', 'KB: R',             'M: 5',              'Circle',            'Circle',            '2',                 '[C] A',             '[W] 2',             'A',                 'X | D-pad down',    'B',                 'B',                 'B',                 'II',                '',                  'A',                 '2',                 '2',                 'C',                 'B',                 'II',                '',                         'C-Down',                   'X',                 '',                  'B',                 'B',                 'B',                 'Circle',           ],
    ['GP: RB Down;  KB: E; M: 6', 'KB: E',             'M: 6',              'X',                 'X',                 '1',                 '[C] B',             '[W] 1',             'B',                 'A | D-pad left',    'A',                 'A',                 'A',                 '*III',              'A',                 'B',                 '1',                 '1',                 'B',                 'C',                 'III',               'A',                        'A',                        'A',                 '2',                 'A',                 'A',                 'A',                 'X',                ],
    ['GP: RB Up;    KB: F; M: 7', 'KB: F',             'M: 7',              'Triangle',          'Triangle',          'A',                 '[C] X',             '',                  'X',                 'Y | D-pad right',   'Y',                 'Y',                 'D',                 '*V',                '',                  'X',                 '',                  '4',                 '*Trigger',          'Y (2)',             'V',                 '',                         'C-Left',                   'Y',                 '',                  '*Y',                'Y',                 'Y',                 'Triangle',         ],
    ['GP: MM; KB: Esc',           'KB: Esc',           '',                  'Start',             'OPTIONS',           '+',                 '[C] +',             '',                  '+',                 '+ | Capture',       'Menu',              'Start',             'Start',             'Run',               'Start',             'Start',             '',                  'Start',             'P',                 'Option',            'Run',               'Start',                    'Start',                    'Start',             '',                  'Start',             'Start',             'Start',             'Start',            ],
    ['GP: MS; KB: Enter',         'KB: Enter',         '',                  'Select',            'SHARE',             '-',                 '[C] -',             '',                  '-',                 '- | Home',          'View',              'Back',              'Select',            'Select',            'Select',            'Select',            '',                  'Coin',              'X',                 'Pause',             'Select',            'Select',                   '',                         '',                  '',                  '*Mode',             '',                  '*D',                'Select',           ],
    ['GP: MT; KB: L Win',         'KB: L Win',         '',                  'PS',                'PS',                'Home',              '[C] Home',          '',                  'Home',              '',                  'Xbox',              'Steam',             'Credit',            '',                  '',                  '',                  '',                  'Service',           'PS',                '5',                 '',                  'Start',                    '**Toggle Ctrl/Rumble pak', '',                  '',                  '',                  '',                  '',                  'Analog',           ],
    ['GP: MQ; KB: Hash',          'KB: Hash',          '',                  '',                  'TouchPad',          '',                  '[W] B',             '',                  'Capture',           '',                  'Share',             'Stick click',       '',                  '',                  '',                  '',                  '',                  '',                  '',                  '8',                 '',                  'Select',                   '**Rotate memory bank',     '',                  '',                  '',                  '',                  '',                  '',                 ],
    ['GP: LM; M: Right',          '',                  'M: Right',          'L2',                'L2',                '',                  '[C] Analog L',      '[N] Z',             'ZL',                'SL',                'LT',                'Analog LT',         '6',                 '*VI',               '',                  'L',                 '',                  '5',                 'L',                 '*Z Axis',           'VI',                'L',                        'Z',                        'Analog L',          '',                  '',                  '*Analog L',         'L',                 'L2',               ],
